...
if (isset($_POST['add'])) {
    ...
    $format = $_POST['format'];
    $isbn = $_POST['isbn'];  // Correct variable
    $shelf = $_POST['shelf'];
    ...
    $checkQuery->bindParam(':isbn', $isbn, PDO::PARAM_STR);  // Use $isbn here
    $checkQuery->execute();

    // If the query returns any row, it means the ISBN already exists
    if ($checkQuery->rowCount() > 0) {
        ...
        $query->bindParam(':isbn', $isbn, PDO::PARAM_STR);  // Again, use $isbn here
