...
if (isset($_POST['signup'])) {
    ...
    if ($checkQuery->rowCount() > 0) {
        ...
        // Query to count how many 'Admin' users already exist
        $sql_check_admins = "SELECT COUNT(*) as admin_count FROM tbluser WHERE Role = 'Admin'";
        ...
        if ($result['admin_count'] < 2) {
            ...
            $sql = "INSERT INTO tbluser(Fname, Mname, Lname, EmailAdd, ContactNo, Username, Password, Role, Status) 
                VALUES(:fname, :mname, :lname, :email, :conNo, :username, :password, :role, :status)";
