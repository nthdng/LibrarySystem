...
if (strlen($_SESSION['login']) == 0) {
    ...
    $role = $_SESSION['role']; // Get user role from session (Librarian or Admin)
    ...
    if (isset($_POST['change'])) {
        ...
        if ($query->rowCount() > 0) {
            ...
            $con = "UPDATE tbluser SET Password = :newpassword, force_password_change = 0 WHERE Username = :username";
