        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    ...
                    <a href="LibaddStudent.php" class="btn btn-success pull-right">+ ADD STUDENT</a>
                    <!-- Import button -->
                    <a href="ImportStudentlib.php" id="import" class="btn btn-primary">
                        Import Data
                    </a>
                </div>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <div>
                                                        <td class="center">
                                                            ...
                                                            <a
                                                                href="LibupdateStudent.php?stdid=<?php echo htmlentities($result->ID); ?>"><button
                                                                    class="btn btn-primary"> Update</button></a>



                                                            <a href="LibstudentList.php?del=<?php echo htmlentities($result->ID); ?>"
