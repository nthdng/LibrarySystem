...
if (isset($_GET['del'])) {
    ...
    if ($facultyData) {
        ...
        echo "<script>alert('Faculty Successfully Removed and Archived'); window.location.href='LibfacultyList.php';</script>";

    } else {
        echo "<script>alert('Faculty not found!'); window.location.href='LibfacultyList.php';</script>";
    }
}
        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    ...
                    <a href="LibaddFaculty.php" class="btn btn-success pull-right">+ ADD FACULTY</a>
                    <!-- Import button -->
                    <a href="ImportFacultylib.php" id="import" class="btn btn-primary">
                        Import Data
                    </a>
                </div>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <div>
                                                        <td class="center">
                                                            ...
                                                            <a
                                                                href="LibupdateFaculty.php?facultyid=<?php echo htmlentities($result->ID); ?>"><button
                                                                    class="btn btn-primary"> Update</button></a>

                                                            <a href="LibfacultyList.php?del=<?php echo htmlentities($result->ID); ?>"
