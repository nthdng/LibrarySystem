...
if (isset($_POST['signup'])) {
    ...
    if ($checkQuery->rowCount() > 0) {
        ...
        echo "<script>alert('Faculty or FacultyID already exists. Please use a different ID.'); window.location.href='LibfacultyList.php';</script>";
    } else {
        ...
        if ($lastInsertId) {
            ...
            try {
                ...
                // Send the email
                $mail->send();
                echo "<script>alert('Registration successful. Email with QR code sent to the recipient.'); window.location.href='LibfacultyList.php';</script>";
            } catch (Exception $e) {
                        ...
                        <div class="panel-body">
                            <form name="signup" method="post" onSubmit="return valid();">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="department" autocomplete="off"
                                        required />
                                </div>
