            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="ddlmenuItem">
                        <li><a href="addCategorieslib.php">Add Category</a></li>
                        <li><a href="addFormatlib.php">Add Format</a></li>
                        <li><a href="addShelflib.php">Add Shelf</a></li>
                    </ul>
                    <script>
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="othersListlib.php?delcat=<?php echo htmlentities($result->ID); ?>"
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="othersListlib.php?delfrmt=<?php echo htmlentities($result->ID); ?>"
                                                           onclick="return confirm('Are you sure you want to delete this format?');">
                                                            <button class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
                                                        </a>
                                                    </td>
                                                </tr>
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="othersListlib.php?delshlf=<?php echo htmlentities($result->ID); ?>"
