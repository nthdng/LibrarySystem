...
if (!isset($_GET['bookid']) || empty($_GET['bookid'])) {
    ...
    $sql = "SELECT * FROM booktbl WHERE ID = :ID";
...
if (isset($_POST['update'])) {
    ...
    WHERE ID = :ID AND isbnNumber = :isbn";
    ...
    if ($updateSuccess) {
        echo "<script>alert('Updated successfully'); window.location.href='bookManagementlib.php';</script>";
    } else {
        echo "<script>alert('Update failed! Please try again.'); window.location.href='bookManagementlib.php';</script>";
    }
}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category" required="required">
                                            ...
                                            foreach ($categories as $category) { ?>
                                                <option value="<?php echo htmlentities($category->ID); ?>" <?php if ($category->ID == $book->category)
                                                       echo 'selected'; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="format" required="required">
                                            ...
                                            foreach ($formats as $format) { ?>
                                                <option value="<?php echo htmlentities($format->ID); ?>" <?php if ($format->ID == $book->format)
                                                       echo 'selected'; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="shelf" required="required">
                                            ...
                                            foreach ($shelves as $shelf) { ?>
                                                <option value="<?php echo htmlentities($shelf->ID); ?>" <?php if ($shelf->ID == $book->shelf)
                                                       echo 'selected'; ?>>
