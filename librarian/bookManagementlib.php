...
if (isset($_GET['del'])) {
    ...
    if ($bookData) {
        ...
        echo "<script>alert('Book Successfully Removed and Archived'); window.location.href='bookManagementlib.php';</script>";
    } else {
        echo "<script>alert('Book not found!'); window.location.href='bookManagementlib.php';</script>";
    }
}
?>
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="ddlmenuItem">
                        <li><a href="importBookslib.php">Import Books</a></li>
                        <li><a href="addBookslib.php">Add New Books</a></li>
                    </ul>
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <!-- Update Book button -->
                                                        <a href="updateBookslib.php?bookid=<?php echo htmlentities($result->ID); ?>">
                                                            <button class="btn btn-primary">Update</button></a>

                                                        <!-- Delete Book button -->
                                                        <a href="bookManagementlib.php?del=<?php echo htmlentities($result->ID); ?>"
