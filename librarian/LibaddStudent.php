...
if (isset($_POST['signup'])) {
    ...
    if ($checkQuery->rowCount() > 0) {
        ...
        echo "<script>alert('Student or StudentID already exists. Please use a different ID.'); window.location.href='LibstudentList.php';</script>";
    } else {
        ...
        if ($lastInsertId) {
            ...
            try {
                ...
                // Send the email
                $mail->send();
                echo "<script>alert('Registration successful. Email has been sent.'); window.location.href='LibstudentList.php';</script>";
            } catch (Exception $e) {
