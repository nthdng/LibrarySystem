...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2024 at 06:47 AM
...
(3, 'Lit-202', 'Shakespeare’s Works', 3, 3, 3, '978-0-14-043908-3', 117, 10002, '2024-11-08 16:39:49', '2024-11-16 05:47:05', 'Existing'),
...
INSERT INTO `borrowtbl` (`borrowID`, `bookID`, `userID`, `fcID`, `stID`, `borrowDate`, `expectedReturnDate`, `status`, `borrowarc`) VALUES
(1, 15, NULL, NULL, NULL, '2024-11-15 16:28:09', '2024-11-15 16:28:09', 'pending', 'Archived'),
(2, 5, NULL, NULL, NULL, '2024-11-15 16:45:11', '2024-11-15 16:45:11', 'pending', 'Archived'),
(3, 15, NULL, NULL, NULL, '2024-11-15 16:45:11', '2024-11-15 16:45:11', 'pending', 'Archived'),
(4, 5, NULL, NULL, NULL, '2024-11-15 16:45:10', '2024-11-15 16:45:10', 'pending', 'Archived'),
(5, 3, NULL, NULL, NULL, '2024-11-15 16:43:54', '2024-11-15 16:43:54', 'pending', 'Archived'),
(6, 3, NULL, NULL, NULL, '2024-11-15 16:43:43', '2024-11-15 16:43:43', 'pending', 'Archived'),
(7, 27, NULL, NULL, NULL, NULL, NULL, 'pending', 'Existing'),
(8, 4, NULL, NULL, NULL, NULL, NULL, 'pending', 'Existing'),
(9, 4, NULL, NULL, NULL, NULL, NULL, 'pending', 'Existing'),
(10, 3, NULL, NULL, NULL, NULL, NULL, 'pending', 'Existing'),
(11, 3, NULL, NULL, NULL, NULL, NULL, 'pending', 'Existing'),
(12, 3, NULL, NULL, NULL, NULL, NULL, 'pending', 'Existing');
...
ALTER TABLE `borrowtbl`
  ...
  ADD CONSTRAINT `borrowtbl_ibfk_3` FOREIGN KEY (`fcID`) REFERENCES `tblfaculty` (`fcID`),
  ADD CONSTRAINT `borrowtbl_ibfk_4` FOREIGN KEY (`stID`) REFERENCES `tblstudent` (`stID`);
