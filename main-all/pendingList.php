...
// Function to fetch borrow records with "pending" status
function getBorrowRecords($dbh)
{
    $sql = "SELECT 
            ...
            WHERE 
                borrowtbl.borrowarc = 'Existing' AND borrowtbl.status = 'pending'";
...
<head>
    ...
    <title>Pending Borrow List</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Pending Borrow List</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        if (count($results) > 0) {
                                            foreach ($results as $result) { ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="issueReserves.php?borrowID=<?php echo htmlentities($result->borrowID); ?>"
                                                            class="btn btn-success">Confirm</a>
                                                    </td>
                                                    <td class="center">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="openArchiveModal(<?php echo htmlentities($result->borrowID); ?>)">Remove</button>
                                                    </td>
                                                </tr>
                                                <?php $cnt++;
                                            }
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">-</td>
                                                <td class="center">-</td>
                                                <td class="center">No pending records found</td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
